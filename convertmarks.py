...
def main(argv: list):
    ...
    parser.add_argument('in_file', help="the input marker file. Audacity "
                                        "Labels and LRC currently supported.")
    parser.add_argument('out_file', help="the output marker file. CUE and LRC "
                                         "currently supported.")
    parser.add_argument('-m', '--media-file', default=None,
    ...
    if out_type == MCS.CUE and namespace.media_file is None:
        raise ValueError("You must pass --media-file when converting to CUE.")
