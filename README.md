...
![Project overview](https://github.com/xbnstudios/show-scripts/raw/master/overview-diagram.png)
...
Pre-generated metadata files can be found [here](https://github.com/xbnstudios/show-scripts-Metadata).