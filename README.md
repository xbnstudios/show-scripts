...
![Project
overview](https://github.com/xbnstudios/show-scripts/raw/master/overview-diagram.png)
...
* **PostShowV2.py** - new and improved version of PostShow developed by [s0ph0s](https://github.com/s0ph0s-2). Changelog can be found [here](https://github.com/xbnstudios/show-scripts/pull/2)
